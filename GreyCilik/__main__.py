...
def cilik_about_callback(update, context):
    ...
    if query.data == "cilik_":
        query.message.edit_text(
            text=gs(chat.id, "help_musik_cilik_text"),
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(text="Play", callback_data="cilik_notes"),
                    ],
                    [
                        InlineKeyboardButton(text="Bot Commands", callback_data="cilik_support"),
                        InlineKeyboardButton(text="Extra Commands", callback_data="cilik_credit"),
                    ],
                    [
                        InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="help_all"),
                    ]
                ]
            ),
        )
        ...
        query.message.edit_text(
            text=gs(chat.id, "admins_mhelp_text"),
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="cilik_"),
                    ]
                ]
            ),
        )
        ...
        query.message.edit_text(
            text=gs(chat.id, "play_mhelp_text"),
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
        ...
        query.message.edit_text(
            text=gs(chat.id, "bot_mhelp_text"),
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
        ...
        query.message.edit_text(
            text=gs(chat.id, "extra_mhelp_text"),
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
...
def help_all_callback(update, context):
    query = update.callback_query
    chat = update.effective_chat
    if query.data == "help_all":
        query.message.edit_text(
            text=gs(chat.id, "help_all_text"),
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=False,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text=gs(chat.id, "help_manage"), callback_data="help_back"),
                    InlineKeyboardButton(text=gs(chat.id, "help_musik"), callback_data="cilik_"),
                 ],
                 [
...
def donate_callback(update, context):
    ...
    if query.data == "donate_":
        query.message.edit_text(
            text=gs(chat.id, "donate_text"),
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=False,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="cilik_back"),
...
def main():
    ...
    help_all_handler = CallbackQueryHandler(
        help_all_callback, pattern=r"help_all", run_async=True
    )
    ...
    donate_handler = CallbackQueryHandler(
        donate_callback, pattern=r"donate_", run_async=True
    )
    ...
    dispatcher.add_handler(help_all_handler)
